 ...
 */
    ...
    dinner::philosopher_setting<dinner::waiter_with_queue> philosoph1 {1, local_waiter, std::chrono::milliseconds(5), std::chrono::milliseconds(5), std::chrono::milliseconds(15),eat_count};
