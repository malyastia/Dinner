...
void dining( int eat_count)
{
    ...
    dinner::philosopher::philosopher_setting philosoph0 {0, for_start_eating_philosopher, local_waiter};
    dinner::philosopher::philosopher_setting philosoph1 {1, for_start_eating_philosopher, local_waiter};
    dinner::philosopher::philosopher_setting philosoph2 {2, for_start_eating_philosopher, local_waiter};
    dinner::philosopher::philosopher_setting philosoph3 {3, for_start_eating_philosopher, local_waiter};
    dinner::philosopher::philosopher_setting philosoph4 {4, for_start_eating_philosopher, local_waiter};
    dinner::philosopher::philosopher_setting philosoph5 {5, for_start_eating_philosopher, local_waiter};
